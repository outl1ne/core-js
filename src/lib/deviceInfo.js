 ...
 * @return {number} Cached viewport height
 */
export function getViewportHeight() {
  return _cacheViewport ? (_viewportHeight || $(window).height()) : $(window).height();
}
...
function onResize(evt = {}) {
  const detail = evt.detail || { width: $(window).width(), height: $(window).height() };
  _viewportWidth = detail.width;
  _viewportHeight = detail.height;
}
